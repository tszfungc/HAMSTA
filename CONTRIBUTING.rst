...
Welcome to ``HAMSTA`` contributor's guide.
...
If you experience bugs or general issues with ``HAMSTA``, please have a look
...
You can help improve ``HAMSTA`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``HAMSTA`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``HAMSTA``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n HAMSTA python=3 six virtualenv pytest pytest-cov
    conda activate HAMSTA
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/HAMSTA.git
    cd HAMSTA
...
#. Install |pre-commit|_::
   ...
   ``HAMSTA`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/HAMSTA
.. _issue tracker: https://github.com/<USERNAME>/HAMSTA/issues
.. <-- end -->
